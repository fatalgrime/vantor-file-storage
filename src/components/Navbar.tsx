    ...
    <header className={`sticky top-0 z-40 border-b transition-colors duration-300 ${
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 px-6 py-3">
        ...
        <div className="flex items-center space-x-3">
          ...
          {canUseRoleSwitcher && (
          <div className={`flex items-center space-x-1 rounded-lg border p-1 text-xs ${
            isDark ? 'bg-slate-900/90 border-slate-700/80' : 'bg-gray-100 border-gray-200'
          }`}>
          ...
          <button
            ...
            className={`flex items-center space-x-1.5 rounded-lg px-3.5 py-1.5 text-xs font-semibold border transition-all ${
              selectedCount > 0
          ...
          {canEditRepository && (
            <div className="flex items-center space-x-1.5">
              <button
                ...
                className={`flex items-center space-x-1 rounded-lg border px-2.5 py-1.5 text-xs font-medium transition-colors ${
                  isDark
          ...
          <button
            ...
            className={`rounded-lg p-2 transition-all border ${
              isDark
                ...
                : 'bg-gray-100 border-gray-200 text-indigo-600 hover:bg-gray-200 hover:text-indigo-800'
            }`}
          ...
          <div className={`pl-2 border-l ${isDark ? 'border-slate-700' : 'border-gray-200'}`}>
            {isSignedIn ? (
              ...
              <SignInButton mode="modal">
                <button className={`rounded-lg px-3.5 py-1.5 text-xs font-semibold transition-all shadow-md ${
                  isDark
      ...
      <div className={`flex flex-wrap items-center justify-between gap-3 border-t px-6 py-2 transition-colors duration-300 ${
        isDark ? 'border-[#1e3059]/60 bg-[#090e1c]' : 'border-gray-100 bg-gray-50'
      }`}>
        {/* Left: Public Share & Filters */}
        <div className="flex items-center space-x-3">
          <div className={`flex items-center space-x-1 text-xs font-medium border px-2.5 py-1 rounded-md ${
            isDark ? 'text-slate-300 bg-slate-900/90 border-slate-800' : 'text-gray-600 bg-white border-gray-200'
          }`}>
          ...
          <div className="relative">
            <select
              ...
              className={`appearance-none border text-xs font-medium rounded-md px-2.5 py-1 pr-6 cursor-pointer focus:outline-none focus:border-blue-500 transition-colors ${
                isDark
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="relative w-48 sm:w-64">
            ...
            <input
              ...
              className={`w-full border rounded-md pl-8 pr-3 py-1 text-xs focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all ${
                isDark
